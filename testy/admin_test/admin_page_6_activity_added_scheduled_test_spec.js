...
describe('Test that Admin Scheduled activity has been add to the calendar', function() {
  ...
  beforeEach(function() {
    ...
    it('should chcek that Admin Scheduled activity has been added', function(){

       // home_page = login_page.loginGood(params.login.user, params.login.password);
        isAngularSite(true);
        var activity_page = home_page.activityGo();
      
        activity_page.findActivity('Admin', 'Scheduled');
