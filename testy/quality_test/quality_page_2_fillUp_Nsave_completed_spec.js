...
describe('Test trying to fill up all Quality Page required fields and save form', function() {
  ...
  beforeEach(function() {
   ...
   it('should - fill up all fields and save Quality Completed activity', function(){
