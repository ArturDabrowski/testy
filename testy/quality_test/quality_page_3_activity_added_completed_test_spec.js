...
describe('Test that Quality Completed activity has been add to the calendar', function() {
  ...
  beforeEach(function() {
    ...
    it('should chcek that Quality Completed activity has been added', function(){
        ...
        activity_page.qualityFindActivityCompleted();
