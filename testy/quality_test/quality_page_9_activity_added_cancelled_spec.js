...
describe('Test that Quality Canceled activity has been add to the calendar ', function() {
  ...
  beforeEach(function() {
    ...
    it('should chcek that Quality Canceled activity has been added', function(){
        ...
        expect(element(by.model('cancelledReason')).getAttribute('value')).toEqual(quality.getCancelReason());
