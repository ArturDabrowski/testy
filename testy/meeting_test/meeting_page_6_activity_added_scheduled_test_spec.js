...
describe('Test that Meeting Scheduled activity has been add to the calendar', function() {
    ...
    it('should chcek that Meeting Scheduled activity has been added', function(){
        ...
        activity_page.findActivity('Meeting', 'Scheduled');
