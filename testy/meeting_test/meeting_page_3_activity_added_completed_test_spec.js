...
describe('Test that Meeting Completed activity has been add to the calendar', function() {
    ...
    it('should chcek that Meeting Completed activity has been added', function(){
        ...
        expect(element(by.model('notes')).getAttribute('value')).toEqual(meeting.getNotesText());
