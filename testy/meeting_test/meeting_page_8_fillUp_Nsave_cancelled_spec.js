...
describe('Test trying to fill up all Meeting Page Canceled required fields and save form', function() {
...
it('should - fill up all fields with Location Account and save Meeting Canceled activity', function(){
    ...
    it('should - fill up all fields with Location Other and save Meeting Canceled activity', function(){
